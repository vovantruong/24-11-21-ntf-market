      ...
      <header className="navbar_item">
        ...
        <Container>
          ...
          <div className="content__profile__view">
            <Row>
              <Col md="3" lg="3" className="bg__profile">
                <div className="detail__profile">
                  <div className="view__profile ">
                    ...
                    <b className="messenger__profile">
                      0xc4c16a645...b21a &nbsp;<i class="far fa-comments"></i>
                    </b>{" "}
                    <br />
                    <div className="content__detail">
                      <b>
                        A wholesome farm ower in <br />
                        Montana. Upcomming gallery <br />
                        solo show in Germany{" "}
                      </b>
                    </div>
                    <div className="link__Profile mt-3">
                      <b>
                        <i class="far fa-globe">&nbsp;</i>https://ui8.net
                      </b>
                    </div>
                    <div className="btn__follower__link__note mt-5">
                      <Link className="follower_profile" to="">
                        Follow
                      </Link>
                      <Link className="link__profile view__like" to="">
                        <i class="fas fa-arrow-up"></i>
                      </Link>
                      <Link className="link__note view__like" to="">
